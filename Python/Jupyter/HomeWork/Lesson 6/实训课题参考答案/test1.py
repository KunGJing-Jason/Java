...
q_1 = '1) 计算A0001、A0002任务位置到所有会员位置的距离，结果采用两个序列来保存，分别记为S_A0001、S_A0002，其中index为会员编号，值为其对应的距离。'
q_2 = '2) 计算A0001任务在5公里范围内的会员个数，记为A0001_Bnum。'
q_3 = '3) 计算A0002任务在5公里范围内所有会员信誉值总和，记为A0002_Bavg。'
